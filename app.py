...
st.set_page_config(layout="centered", page_title="Gibbs Triangle (Light Gradient)")

st.title("Simple Gibbs Triangle (Light Blue-Pink Gradient)")
...
if C < 0:
    ...
    # User point
    x, y = ternary_to_cartesian(A, B, C)
    ax.plot(x, y, 'ro', markersize=16, zorder=4)
    ax.text(x, y + 0.03, f"({A:.1f}, {B:.1f}, {C:.1f})", ha='center', fontsize=15, fontweight='bold', color='black', zorder=5)
