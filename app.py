...
if A + B > 100:
    ...
    # Clip path
    clip_path = patches.PathPatch(triangle_path, transform=ax.transData)

    # Phase regions with clipping
    ...
    for i in range(5, 100, 5):
        f = i / 100
        is_major = i % 10 == 0
        color = '#ffffff' if is_major else '#cccccc'  # Higher contrast
    ...
    # Plot selected composition point
